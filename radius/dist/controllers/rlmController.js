...
exports.rlmController = {
    ...
    async authorize(req, res) {
        try {
            ...
            if (!customer) {
                ...
                if (hotspotVoucher) {
                    ...
                    if (hotspotVoucher.lastUsedAt && hotspotVoucher.package) {
                        const durationMs = exports.rlmController.getDurationInMs(hotspotVoucher.package.durationType);
            ...
            if (packageData) {
                ...
                const baseSessionTimeout = exports.rlmController.calculateSessionTimeout(packageData);
                ...
                if (isHotspotVoucher && hotspotVoucher && hotspotVoucher.lastUsedAt && packageData) {
                    const durationMs = exports.rlmController.getDurationInMs(packageData.durationType);
    ...
    async accounting(req, res) {
        try {
            const { username, acct_status_type, acct_session_id, acct_input_octets, acct_output_octets, acct_input_packets, acct_output_packets, acct_input_gigawords, acct_output_gigawords, acct_session_time, nas_ip_address, nas_port, framed_ip_address, calling_station_id, called_station_id, acct_terminate_cause, acct_authentic, acct_delay_time, service_type, framed_protocol, framed_mtu, connect_info, user_agent } = req.body;
    ...
    async checkSimultaneous(req, res) {
        try {
    ...
    calculateSessionTimeout(packageData) {
...
//# sourceMappingURL=rlmController.js.map